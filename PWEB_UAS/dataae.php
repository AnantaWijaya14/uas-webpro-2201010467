...
if (isset($_POST["act"])) {
    ...
    switch ($act) {
        case "store":
            ...
            $idae = md5($umur);
            $sql = "INSERT INTO tbae(nama, nickname, umur, role, jeniskelamin, negara, idae) VALUES('$nama','$nickname', '$umur', '$role', '$jeniskelamin','$negara', '$idae');";
        ...
        case "update":
            ...
            $negara = $_POST["txNEGARA"];
            $idae = $_POST["idae"];
            $sql = "UPDATE tbae SET nama='$nama', nickname='$nickname', umur='$umur', role ='$role' , jeniskelamin ='$jeniskelamin', negara = '$negara' WHERE idae='$idae';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
        ...
        case "destroy":
            $idae = $_POST['idae'];
            $sql = "DELETE FROM tbae WHERE idae='$idae';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
...
if (isset($_GET["aksi"])) {
    ...
    switch ($aksi) {
        case "new":
            $jdpage = "Tambah";
            $pg = "team/ae/newae.php";
            break;
        case "edit":
            $jdpage = "Ubah";
            $pg = "team/ae/editae.php";
            break;
        case "del":
            $jdpage = "Hapus";
            $pg = "team/ae/delae.php";
            break;
        default:
            $jdpage = "List";
            $pg = "team/ae/listae.php";
...
<head>
    ...
    <title><?= $jdpage ?> - Data Pemain ae</title>
