...
if (isset($_POST["act"])) {
    ...
    switch ($act) {
        case "store":
            ...
            $idbtr = md5($umur);
            $sql = "INSERT INTO tbbtr(nama, nickname, umur, role, jeniskelamin, negara, idbtr) VALUES('$nama','$nickname', '$umur', '$role', '$jeniskelamin','$negara', '$idbtr');";
        ...
        case "update":
            ...
            $negara = $_POST["txNEGARA"];
            $idbtr = $_POST["idbtr"];
            $sql = "UPDATE tbbtr SET nama='$nama', nickname='$nickname', umur='$umur', role ='$role' , jeniskelamin ='$jeniskelamin', negara = '$negara' WHERE idbtr='$idbtr';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
        ...
        case "destroy":
            $idbtr = $_POST['idbtr'];
            $sql = "DELETE FROM tbbtr WHERE idbtr='$idbtr';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
...
if (isset($_GET["aksi"])) {
    ...
    switch ($aksi) {
        case "new":
            $jdpage = "Tambah";
            $pg = "team/btr/newbtr.php";
            break;
        case "edit":
            $jdpage = "Ubah";
            $pg = "team/btr/editbtr.php";
            break;
        case "del":
            $jdpage = "Hapus";
            $pg = "team/btr/delbtr.php";
            break;
        default:
            $jdpage = "List";
            $pg = "team/btr/listbtr.php";
...
<head>
    ...
    <title><?= $jdpage ?> - Data Pemain btr</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Data Pemain BTR</h1>
                </div>
                <?php
                include($pg);
                ?>
