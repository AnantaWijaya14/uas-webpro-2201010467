...
$idevos = $_GET["p1"];
$sql = "SELECT tu.nama,tu.nickname, tu.umur, tu.role , tu.jeniskelamin, tu.negara FROM tbevos tu WHERE tu.idevos='$idevos';";
...
?>
    ...
    <form method="POST" action="dataevos.php">
        ...
        <input type="hidden" name="idevos" value="<?= $idevos ?>">
...
<?php
    ...
    echo "<script>window.location.href='dataevos.php';</script>";
}
