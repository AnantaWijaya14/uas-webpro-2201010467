...
if (isset($_POST["act"])) {
    ...
    switch ($act) {
        case "store":
            ...
            $idaura = md5($umur);
            $sql = "INSERT INTO tbaura(nama, nickname, umur, role, jeniskelamin, negara, idaura) VALUES('$nama','$nickname', '$umur', '$role', '$jeniskelamin','$negara', '$idaura');";
        ...
        case "update":
            ...
            $negara = $_POST["txNEGARA"];
            $idaura = $_POST["idaura"];
            $sql = "UPDATE tbaura SET nama='$nama', nickname='$nickname', umur='$umur', role ='$role' , jeniskelamin ='$jeniskelamin', negara = '$negara' WHERE idaura='$idaura';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
        ...
        case "destroy":
            $idaura = $_POST['idaura'];
            $sql = "DELETE FROM tbaura WHERE idaura='$idaura';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
...
if (isset($_GET["aksi"])) {
    ...
    switch ($aksi) {
        case "new":
            $jdpage = "Tambah";
            $pg = "team/aura/newaura.php";
            break;
        case "edit":
            $jdpage = "Ubah";
            $pg = "team/aura/editaura.php";
            break;
        case "del":
            $jdpage = "Hapus";
            $pg = "team/aura/delaura.php";
            break;
        default:
            $jdpage = "List";
            $pg = "team/aura/listaura.php";
...
<head>
    ...
    <title><?= $jdpage ?> - Data Pemain aura</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Data Pemain AURA</h1>
                </div>
                <?php
                include($pg);
                ?>
